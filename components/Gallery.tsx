...
export default function Gallery() {
  ...
  return (
    <section id="realizacje" ref={sectionRef} className="section-padding bg-panel bg-texture-romby">
      <div className="container-custom">
        <div className="text-center mb-10 sm:mb-12 md:mb-14 lg:mb-18 animate-on-scroll">
          ...
          <p className="text-base sm:text-lg text-gray-400 max-w-2xl mx-auto px-1 sm:px-0">
            Efekty naszych prac – każdy pojazd traktujemy indywidualnie.
          </p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-6">
          {realizacje.map((item, index) => (
            <div
              ...
              className="relative aspect-[4/3] rounded-xl sm:rounded-2xl overflow-hidden shadow-card animate-on-scroll group block min-h-[180px] sm:min-h-0"
